<template>
    <Upload
        ...
        action=""
        >
        <div class="upload-mask-audio" :style="style">
            <Spin fix v-if="spin"></Spin>
            <div v-if="!file.name">
                <Icon color="#24A7EA" :size="28" type="md-add-circle" />
                <p class="upload-mask-tit">点击上传音频</p>
                <p class="upload-mask-des">或将音频拖到此处</p>
            </div>
            <div v-else class="upload-audio-info" :style="style" @click.stop.prevent="fn">
                <div class="list text-elips">
                ...
                <div class="text-left">
                    <Button @click.stop="start" v-if="state === 0" type="primary" ghost >开始上传</Button>
