...
import { PageZhDemandInventoryAsync,DeleteZhDemandInventoryAsync } from "@/api/Comprehensive";
...
export default {
  ...
  methods: {
    loadData() {
      ...
      PageZhDemandInventoryAsync(this.ClearParams(params))
        .then(res => {
