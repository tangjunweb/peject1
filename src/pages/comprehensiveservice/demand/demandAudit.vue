        ...
        <Row :gutter="15" style="margin-bottom:20px;" type="flex">
            ...
            <top-card class='orginalmanage-topcard'>
                <ul class='formLine' style="padding:0 60px">
                    ...
                    <li>
                        <div class='orginalmanage-title'>资源类型：</div>
                        <div class='orginalmanage-body'>党建资源/需求</div>
                    </li>
                    <li>
                        <div class='orginalmanage-title'>资源内容：</div>
                        <div class='orginalmanage-body'>这里显示已填写好的资源清单内容这里显示已填写好的资源清单内容</div>
                    </li>
