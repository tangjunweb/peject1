          ...
          <Col :span="24" class="partymember-select">
            <Form>
              <Row :gutter="30" type='flex'>
                <Col>
                  <FormItem label="考试名称" :label-width="80">
                    <Input v-model="searchParams.PaperName" placeholder="输入考试名称"></Input>
                  </FormItem>
                </Col>
                <Col>
                  <Button
          ...
          <Col :span="7">
            <div class="party-member-right">
              <div class="party-member-head">
                <div class="party-member-hc">已选择考试</div>
...
import { GetPagedAdminPaperList } from "@/api/education";
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      GetPagedAdminPaperList(this.ClearParams(params))
        .then(res => {
