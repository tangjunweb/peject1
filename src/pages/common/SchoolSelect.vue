          ...
          <Col :span="24" class="partymember-select">
            <Form>
              <Row :gutter="30" type='flex'>
                <Col>
                  <FormItem label="姓名或电话关键字" :label-width="130">
          ...
          <Col :span="7">
            <div class="party-member-right">
              <div class="party-member-head">
                <div class="party-member-hc">已选择院校</div>
...
import { PartySchoolServicePageListAsync } from "@/api/education";
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      PartySchoolServicePageListAsync(this.ClearParams(params))
        .then(res => {
